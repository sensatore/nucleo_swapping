...
init_idt:
	...
	// TESI
	// primitive per il livello I/O dedicate al processo swapper
	carica_gate TIPO_SWAP_OP 		a_get_swap_op 		LIV_SISTEMA
	carica_gate TIPO_SWAP_OP_END 	a_terminate_swap_op LIV_SISTEMA
	carica_gate TIPO_ADAEMON		a_activate_daemon	LIV_SISTEMA
...
a_activate_p:
	...
	.cfi_offset rip, -40
	.cfi_offset rsp, -16
	// non si effettua salvataggio e caricamento dello stato in quanto la activate_p
	// non e' atomica causa possibili chiamate a swap_out bloccanti
    call c_activate_p
    iretq
	.cfi_endproc
...
a_terminate_swap_op:
	...
	.cfi_offset rsp, -16
	call salva_stato
	call c_terminate_swap_op
	call carica_stato
	iretq
	.cfi_endproc

	.extern c_activate_daemon
a_activate_daemon:
	.cfi_startproc
	.cfi_def_cfa_offset 40
	.cfi_offset rip, -40
	.cfi_offset rsp, -16
	// non si effettua salvataggio e ripristino dello stato
	// poiche' c_activate_daemon chiama c_activate_p che non
	// e' atomica
	call c_activate_daemon
	iretq
	.cfi_endproc
