...
// TESI
/// @name Primitive dedicate allo swapping
///
/// @{
#define TIPO_SWAP_OP        0x37 ///< get_swap_op()
#define TIPO_SWAP_OP_END    0x38 ///< terminate_swap_op()
#define TIPO_ADAEMON        0x39 ///< activate_daemon()
/// @}
// TESI
...
// TESI
/// @name Costanti riguardanti lo swapping di processi
///
/// @{
#define MAX_SWAPPED_PROC 32 ///< massimo numero di processi swappabili in area di swap (modificabile)
#define SWAP_MEM_SIZE (DIM_USR_STACK + DIM_SYS_STACK) ///< dimensione della memoria di un processo soggetta a swap (dimensione partizione)
#define SWAP_FRAME_NUM (SWAP_MEM_SIZE / DIM_PAGINA) ///< numero di frame fisici coinvolti in una operazione di swap
#define BLOCKS_PER_SWAP_PARTITION (SWAP_MEM_SIZE / DIM_BLOCK) ///< numero di blocchi dell'hd occupati da una partizione di swap
#define BLOCKS_PER_FRAME (DIM_PAGINA / DIM_BLOCK) ///< numero blocchi dell´hd occupati da un frame
#define SWAP_PARTITION_SIZE (SWAP_MEM_SIZE * MAX_SWAPPED_PROC) ///< dimensione della partizione dell'hd dedicata allo swap
/// @}
// TESI
